...
internal static class WeatherBedOverrides
{
    private static readonly (AssetLocation Target, AssetLocation Replacement)[] Replacements =
    {
        ...
        (new AssetLocation("game:sounds/weather/wind-leafless.ogg"), new AssetLocation("vintagestorysurroundsound:sounds/weather/wind-surround-leafless.wav")),
        (new AssetLocation("game:sounds/weather/wind-leafy.ogg"), new AssetLocation("vintagestorysurroundsound:sounds/weather/wind-surround-leafy.wav")),
